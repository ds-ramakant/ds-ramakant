...
kable(freq_table_long10, "html", 
      caption = "Top 10 letters within \neach position") %>%
    kable_styling() %>%
...
With that out of the way, I was able to determine that there are **39 words** that can be formed with the top 5 occuring letters in each position. Scroll below to find out. 
